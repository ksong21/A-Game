...
function turnOnEasteregg() {
    if (clicked == false) {
        ...
        let activated = document.createElement('p');
        activated.innerHTML = "Easteregg Activated";
        activated.id = "activated";
        activated.style.position = "relative";
        activated.style.zIndex = "10";
        activated.className = "aboutTextEaster";
        activated.top = "-100px";
        aboutTextEaster.appendChild(activated);
        activated.style.color = "#3498db";
        changeFaces();
        clicked  = true;
    }
}
